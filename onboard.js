...
(function () {
  ...
  // Колір щабля для іскор — дзеркало CSS-змінних --lvl-* (style.css: A1–A2 солома,
  // B1 бронза, B2 фіолет, C1–C2 синь). canvas не читає CSS-змінні, тому хардкод.
  const LEVEL_HUE = {
    A1: "#d9a441", A2: "#d9a441", B1: "#b4632c", B2: "#6f5a9e", C1: "#3f7fb5", C2: "#3f7fb5"
  };
