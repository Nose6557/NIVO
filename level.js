...
(function () {
  ...
  /** Користувач сам обрав рівень зі списку. Фіксацію не чіпаємо — нею керує
      окремий перемикач; поки не зафіксовано, адаптив стартує від цього значення
      (placement без тесту). */
  function setManual(lv) { return seed(lv, "manual"); }
